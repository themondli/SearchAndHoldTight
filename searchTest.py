...
if __name__ == "__main__":
    ...
    run(searchExample.shortestDistance, "shortestDistance")
# also test graphs with cycles, and graphs with multiple least-cost paths

import searchExample
from searchGeneric import Searcher, BFSSearcher

searcherOne = Searcher(searchExample.problem1)
searcherTwo = BFSSearcher(searchExample.problem1)
searcherThree = Searcher(searchExample.simp_delivery_graph)
searcherFour = BFSSearcher(searchExample.simp_delivery_graph)
searcherFive = Searcher(searchExample.cyclic_simp_delivery_graph)
searcherSix = BFSSearcher(searchExample.cyclic_simp_delivery_graph)
searcherSeven = Searcher(searchExample.shortestDistance)
searcherEight = BFSSearcher(searchExample.shortestDistance)
searcherOne.search()
searcherTwo.search()
searcherThree.search()
searcherFour.search()
searcherFive.search()
searcherSix.search()
searcherSeven.search()
searcherEight.search()